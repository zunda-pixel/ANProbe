...
// AccessoryNotifications watch path end-to-end (#29, #131):
...
//   • PeripheralTestModel — the #47 experiment; it confirmed that creating a
//     CBPeripheralManager in an AccessorySetupKit app hard-aborts.
//
// Both were removed for the production companion app. The findings live in
// issues #29 / #47 / #131. Intentionally left empty to avoid a project-file edit.
